...
async function updateDirectoryListLMS() {
    const URL_LMS_API = core.getInput('URL_LMS_API')
    const LMS_DIRECTORY_LIST_TOKEN = core.getInput('LMS_DIRECTORY_LIST_TOKEN')
    const TAB_NAME = core.getInput('TAB_NAME')
    const WIDGET_NAME = core.getInput('WIDGET_NAME')
    try {
        const response = await axios.get(`${URL_LMS_API}/lmsmicrofrontend/updateDirectoryListLMS/${TAB_NAME}/${WIDGET_NAME}`, { headers: { "Authentication": LMS_DIRECTORY_LIST_TOKEN } })
